									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<span>Nip </span>
												<input type="text" id="nip" name="nip" class="form-control" placeholder="Masukan nip pegawai" value="<?php echo $data[0]['asn_nip']; ?>" readonly>	
											</div>											
											<div class="form-group">
												<span>Nama </span>
											...
											<div class="form-group">
												<span>Satker</span>
												<input type="text" name="satker" class="form-control" placeholder="Masukan satker pegawai" value="<?php echo $data[0]['skpd_nama']; ?>" readonly>
											</div>											
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<span>Skpd</span>
												<input type="text" name="skpd" class="form-control" placeholder="Masukan skpd pegawai" value="<?php echo $data[0]['skpd_nama']; ?>" readonly>
											</div>											
											<div class="form-group">
												<span>Tipe id</span>
											...
											<a href="<?=base_url('admin/tambah_listing_proses/'.$data[0]['asn_nip'])?>" class="btn btn-primary" style="float: center" >Tambah Ke Listing</a>
											&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
											<a href="<?=base_url('admin')?>" class="btn btn-warning" style="float: right" >Kembali</a>
								</div>
							</div>
						</div>
					</div>
