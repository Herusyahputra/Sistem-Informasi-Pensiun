										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													<a data-toggle="tooltip" title="Ubah" href="<?php echo base_url().'admin/pegawai_ubah/'.$data['asn_nip']?>"><button
													type="button" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-edit"></span></button></a>
